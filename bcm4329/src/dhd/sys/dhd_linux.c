...
#ifdef CUSTOMER_HW
extern int qsd8x50_wlan_set_carddetect(int val);
#endif /* CUSTOMER_HW */
/*
 ...
 */
char firmware_softap_path[MOD_PARAM_PATHLEN]="";		//added by j00165480 for softap
...
uint wlan_chip_detect= TRUE;
module_param(wlan_chip_detect, uint, 0);
...
uint dhd_sdiod_drive_strength = 8; /** BCM_VINO changed to 8 from 6 */
...
#if defined(HUAWEI_QUICK_TOGGLE_WIFI)
#if defined(CONFIG_WIRELESS_EXT)
			/* Attach and link in the iw */
			wl_iw_detach();
#endif     /* (CONFIG_WIRELESS_EXT) */
