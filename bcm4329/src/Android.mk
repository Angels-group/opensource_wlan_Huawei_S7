...
DHDKO_OUT := $(ANDROID_PRODUCT_OUT)/obj/dhd-cdc-sdmmc-gpl-2.6.32.9-ideos

.PHONY: dhdko
dhdko: $(DHDKO_OUT)/dhd.ko
	cp $(DHDKO_OUT)/dhd.ko $(TARGET_OUT)/lib/modules/dhd.ko

$(DHDKO_OUT)/dhd.ko: bootimage
	@mkdir -p $(DHDKO_OUT)
	make -C $(ANDROID_BUILD_TOP)/hardware/broadcom/wlan/bcm4329/src/dhd/linux dhd-cdc-sdmmc-gpl

file := $(TARGET_OUT)/lib/modules/dhd.ko
$(file) : $(DHDKO_OUT)/dhd.ko | $(ACP)
